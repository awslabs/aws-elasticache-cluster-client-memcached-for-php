...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Memcached_createAndSetTLSContext, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, context_config, IS_ARRAY, 0)
ZEND_END_ARG_INFO()
...
ZEND_METHOD(Memcached, createAndSetTLSContext);
#if defined(HAVE_MEMCACHED_SASL)
...
static const zend_function_entry class_Memcached_methods[] = {
	...
	ZEND_ME(Memcached, createAndSetTLSContext, arginfo_class_Memcached_createAndSetTLSContext, ZEND_ACC_PUBLIC)
#if defined(HAVE_MEMCACHED_SASL)
